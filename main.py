...
if __name__ == '__main__':
    ...
    val_data = np.load('./Data/'+data_path+'/val.npy', allow_pickle=True)
    test_data = np.load('./Data/'+data_path+'/val.npy', allow_pickle=True)
    ...
    for epoch in range(num_epoch):
        ...
        val_precision, val_recall, val_ndcg, val_hk, val_hk_recall = full_t(epoch, model, 'Train', writer)
        ...
        if test_recall > max_recall:
            ...
            if num_decreases > 20:
                ...
                weight_file = f"./checkpoints/{data_path}-finally-Recall_{max_recall}-NDCG_{max_NDCG}.pth.tar"
